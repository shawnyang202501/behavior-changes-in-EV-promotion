/**************************************************************************
 ...
 Notes:
   ...
   3. Baseline treatment: t10i3
      - Interpreted in the manuscript as sustained local EV market entry.
   4. Alternative treatment: treat10
      - Used as a robustness check for treatment definition.
   5. Outcomes:
      - lnnsales     = log-transformed total LDPV sales
      - lnnfuelsales = log-transformed ICEV sales
   6. Core controls:
      - GDPper, GDPrate, pop, income, pass, aqi, pubexp
   7. fect options:
      - unit(id): panel unit identifier
      - time(ym): monthly time identifier
      - se: estimate standard errors
      - nboots(10000): bootstrap repetitions
